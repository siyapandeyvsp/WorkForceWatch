'use client';
import { AppShell, Burger, Button, Group, Modal, Paper, Stack } from '@mantine/core';
import { Switch, useMantineTheme, rem } from '@mantine/core';
import { IconCheck, IconLogin, IconLogout, IconMoonStars, IconSun, IconX } from '@tabler/icons-react';
...
export default function Layout({ children }) {
  ...
  return (
    ...
    />
{checked && <p>Working since : {formatTime(timer)}</p>}              </Group>
        </Group>
      </AppShell.Header>
      ...
      >
        ...
        <Switch
          ...
          onChange={(event) => setVideoRecording(event.currentTarget.checked)}
          label="Start video recording"
        />
        <Switch
          checked={isScreenRecording}
          onChange={(event) => setScreenRecording(event.currentTarget.checked)}
